...
export class Ray {
    constructor() {
        ...
        this.isGravityWellRay = false; // True if it's the BOSS's gravity ball
        this.isPlayerAbilityRay = false; // MODIFIED: True if launched by a player ability like Mini Gravity Well
        this.customRadius = 0;
    ...
    reset(x, y, color, dx, dy, globalSpeedMultiplier, playerInstance, maxLifetimeForThisRay,
        ...
        this.isPlayerAbilityRay = false; // MODIFIED: Reset this flag
    ...
    detonate(detonateContext) {
        ...
        this.absorbedRays.forEach(ray => {
            if (ray && ray.isActive) {
                ...
                ray.speed = (ray.initialSpeedMultiplier * BASE_RAY_SPEED) * 2.0;
                ray.initialSpeedMultiplier = (ray.initialSpeedMultiplier * 2.0);
                ...
                ray.isPlayerAbilityRay = true; // MODIFIED: Mark as an ability-launched ray
            }
        });
        this.absorbedRays = [];
